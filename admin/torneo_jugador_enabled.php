...
$aPersona = $oPersona->getByID($nPerID);
...
<form action="torneo_jugador_guardar.php" enctype="multipart/form-data" method="post">
    <input type="hidden" name="ID" value="<?php echo $aPersona['ID']; ?>" id="PerID">
    ...
    <table > 
        <tr>
            <td>Nombre:</td>
            <td><input type="text"  name="NOMBRE" disabled="disabled" value="<?php echo $aPersona['NOMBRE']; ?>" id="PerName"/></td>
        </tr>
        <tr>
            <td>Primer apellido:</td>
            <td><input type="text" name="APELLIDO1" disabled="disabled" value="<?php echo $aPersona['APELLIDO1']; ?>" id="PerApe1" /></td>
        </tr>
        <tr>
            <td>Segundo apellidos:</td>
            <td><input type="text" name="APELLIDO2" disabled="disabled" value="<?php echo $aPersona['APELLIDO2']; ?>" id="PerApe2"/></td>
        </tr>
        <tr>
            <td>Cedula:</td>
            <td><input type="text" name="CED" disabled="disabled" value="<?php echo $aPersona['CED']; ?>" id="PerCED"/></td>
        </tr> 
    </table>
    <br/>
    <h2>Cargos</h2>
